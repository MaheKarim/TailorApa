...
Route::post('status_change','CustomOrderController@bookingStatusStore')->name('statusChangeOpt');
Route::get('/booking/delete/{id}', 'CustomOrderController@delete')->name('bookingDelete');
